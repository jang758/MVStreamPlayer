...
def _find_ffmpeg():
    ...
    common_paths = [
        ...
        r"C:\Users\weize\Downloads\LosslessCut_V3.66.1\resources\ffmpeg.exe",
    ...
    for ff in project_dir.rglob("ffmpeg.exe"):
        _ffmpeg_path = str(ff)
        print(f"[ffmpeg] 프로젝트 내 발견: {ff}")
        return str(ff)
